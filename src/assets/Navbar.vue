    ...
    <div class="navbar">
      <div class="nav-container">
        ...
        <div class="logo" v-if="load">
            ...
            <Button type="button" class="btn-refresh" severity="danger" label="Cencellati" icon="pi pi-trash" :loading="isLoading" @click="() => router.push('/trashed-books')"  v-if="!route.path.includes('/trashed-books') && userRole?.includes('Amministratore') && (users.feedback.login || users.feedback.created)" />
